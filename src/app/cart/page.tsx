    ...
    return (
        <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
            ...
            {cartLength === 0 ? (
                ...
                <Stack spacing={2}>
                    {cart.map((item, index) => (
                        <Card key={index} sx={{ display: "flex", flexDirection: { xs: "column", sm: "row" }, p: 2 }}>
                            <CardMedia
                                component="img"
                                sx={{ width: { xs: "100%", sm: 200 }, height: { xs: "100%", sm: 200 }, objectFit: "contain" }}
                                image={item.image}
                                alt={item.imageTitle}
                            />
                            ...
                            >
                                ...
                                <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                                    ...
                                    <IconButton color="error" onClick={() => dispatch(removeProduct(item))}>
                                        <Delete />
                                    </IconButton>
